...
<head>
    ...
    <link href="../../assets/modules/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
</head>
                    ...
                    <form class="form">
                        ...
                        <div class="content">
                            ...
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="text" name="check" placeholder="验证码" class="form-control" />
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                            ...
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="password" name="passwordAgain" placeholder="再输入一次密码" class="form-control" />
                            </div>
                        </div>
                        <div class="footer text-center">
                            <a href="#pablo" class="btn btn-primary btn-round btn-lg btn-block">确认
                            </a>
                        </div>
                        <div class="pull-left">
                            <h6>
